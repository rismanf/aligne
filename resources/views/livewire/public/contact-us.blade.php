     ...
     <section id="hero" class="hero banner contact">
                <div class="grid grid__stack">
                    <div class="bg__right bg__img">
                        <img
                            class="only__desktop"
                            src="/assets/img/banner-bg-contact.webp"
                            alt="Banner"
                        />
                        <img
                            class="only__mobile"
                        ...
                        <div class="row">
                            <div class="col-md-7">
                                <div class="section__content">
                                    <div
                                        class="section__heading text--danger text__xl"
                                    >
                                        <h1>Get in Touch</h1>
                                        <p>
                                        ...
                                        <div class="link__wrapper vstack">
                                            <a
                                                href="mailto:sales.admin@neutradc.com"
                                                class="cta cta__alt"
                                            >
                                                <svg
                                                    class="icon"
            ...
            <section id="contact" class="contact">
                <div class="container">
                    <div class="section__content">
                        <div
                            class="form__wrapper bg__danger bg__danger--linear bg__danger"
                        >
                            <form class="row g-4">
                                <div class="col-md-6">
                                    <input
                                ...
                                <div class="col-12">
                                    <div class="form-check">
                                        <input
                                            ...
                                            value=""
                                            id="contactTerms"
                                            aria-describedby="contactTermsFeedback"
                                            required
                                        />
                                        <label
