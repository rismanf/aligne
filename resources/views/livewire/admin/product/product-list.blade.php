        ...
        <x-form wire:submit="save">
            ...
            <div class="alert alert-info mb-4">
                ...
                <div>
                    ...
                    <div class="text-xs">
                        <strong>Flexible:</strong> Total quota dapat digunakan untuk semua jenis kelas (contoh: Aligné Flow 12x bisa untuk Reformer ATAU Chair)<br>
                        <strong>Fixed:</strong> Quota terpisah per jenis kelas (contoh: Aligné Lumina 4x Reformer DAN 2x Chair)
                    </div>
                </div>
            </div>
            ...
            @if($quota_strategy === 'flexible')
                <div class="alert alert-success mb-4">
                    ...
                    <div>
                        ...
                        <div class="text-xs">Semua kelas akan menggunakan quota yang sama. User dapat memilih kelas mana saja yang tersedia.</div>
                    </div>
                </div>
            @elseif($quota_strategy === 'fixed')
                <div class="alert alert-warning mb-4">
                    ...
                    <div>
                        ...
                        <div class="text-xs">Setiap jenis kelas memiliki quota terpisah. User hanya bisa menggunakan quota sesuai jenis kelas.</div>
                    </div>
                </div>
            @endif
            ...
            @foreach ($class_kuotas as $index => $ck)
                <div class="border rounded-lg p-4 mb-4 bg-base-100">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        @if($quota_strategy === 'flexible')
                            <x-input label="Total Quota (Shared)" wire:model="class_kuotas.{{ $index }}.kuota" placeholder="e.g., 12" 
                                hint="Quota ini akan dibagi untuk semua jenis kelas" />
                        @else
                            <x-input label="Quota for This Class Type" wire:model="class_kuotas.{{ $index }}.kuota" placeholder="e.g., 4" 
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        @if($quota_strategy === 'flexible')
                            <x-input label="Total Quota (Shared)" wire:model="class_kuotas.{{ $index }}.kuota" 
                                hint="Quota ini akan dibagi untuk semua jenis kelas" />
                        @else
                            <x-input label="Quota for This Class Type" wire:model="class_kuotas.{{ $index }}.kuota" 
                                hint="Quota khusus untuk jenis kelas ini" />
                        @endif
                    </div>
                </div>
