<div>
    ...
    <div class="mb-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <x-stat 
                ...
                icon="o-user-group"
                tooltip-bottom="Total registered members" 
                color="text-blue-600"
            ...
            <x-stat 
                title="✅ Member Aktif" 
                value="{{ number_format($active_members) }}" 
                icon="o-check-circle"
                tooltip-bottom="Active approved members" 
            ...
            <x-stat 
                ...
                value="{{ number_format($inactive_members) }}" 
                icon="o-x-circle"
                tooltip-bottom="Inactive or pending members" 
                color="text-red-600"
    ...
    <div class="mb-6">
        <div class="flex justify-between items-center mb-4">
            ...
            <div class="flex gap-2">
                <x-input 
                    wire:model.live="transaction_date_from" 
                    type="date" 
                    placeholder="From Date"
                    class="input-sm" />
                <x-input 
                    wire:model.live="transaction_date_to" 
                    type="date" 
                    placeholder="To Date"
                    class="input-sm" />
            </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <x-stat 
                ...
                value="{{ number_format($total_transactions) }}" 
                icon="o-document-text"
                tooltip-bottom="Total transactions in selected period" 
            ...
            <x-stat 
                title="💰 Paid" 
                value="{{ number_format($paid_transactions) }}" 
                icon="o-check-badge"
                tooltip-bottom="Successfully paid transactions" 
                color="text-green-600"
                class="bg-green-50 border-green-200" />

            <x-stat 
                title="⏳ Waiting Confirmation" 
                value="{{ number_format($waiting_confirmation) }}" 
                icon="o-clock"
                tooltip-bottom="Transactions waiting for confirmation" 
                color="text-yellow-600"
                class="bg-yellow-50 border-yellow-200" />

            <x-stat 
                title="🕓 Pending Payment" 
                value="{{ number_format($pending_payment) }}" 
                icon="o-exclamation-triangle"
                tooltip-bottom="Transactions pending payment" 
    ...
    <div class="mb-6">
        <div class="flex justify-between items-center mb-4">
            ...
            <div class="flex gap-2">
                <x-input 
                    wire:model.live="trainer_date_from" 
                    type="date" 
                    placeholder="From Date"
                    class="input-sm" />
                <x-input 
                    wire:model.live="trainer_date_to" 
                    type="date" 
                    placeholder="To Date"
                    class="input-sm" />
            </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-1">
                <x-stat 
                    title="👥 Jumlah Trainer" 
                    value="{{ number_format($total_trainers) }}" 
                    icon="o-academic-cap"
                    tooltip-bottom="Total registered trainers" 
    ...
    <!-- Modal Detail -->
    <x-modal wire:model="showModal" title="{{ $type }} Details" class="backdrop-blur" box-class="!max-w-6xl">
